...
const DoctorAppointments = () => {
    const { appointments, getAppointments, dToken, cancleAppointment, completeAppointment } = useContext(DoctorContext)
            ...
            <div className='bg-white border border-gray-200 rounded text-sm max-h-[80vh] min-h-[50vh] overflow-y-scroll'>
...

                {
                    appointments.reverse().map((item, index) => (
                        <div key={index} className='flex flex-wrap justify-between max-sm:gap-5 max-sm:text-base sm:grid grid-cols-[0.5fr_2fr_1fr_1fr_3fr_1fr_1fr] gap-1 items-center text-gray-500 px-6 py-3 border-b border-gray-300 hover:bg-gray-50'>
