...
const AddDoctor = () => {
    ...
    return aToken && (
        <form onSubmit={onSubmitHandler} className='m-5 w-full' action="">
            ...
            <div className='bg-white px-8 py-8 rounded border border-white w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                ...
                <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            <p>Fees</p>
                            <input onChange={(e)=>setFess(e.target.value)} value={fees} className='border border-gray-200 rounded px-3 py-2 '  type="number" placeholder='fees' required />
                        </div>
                    </div>
                    {/* right side*/}
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                ...
                <div>
                    ...
                    <textarea  onChange={(e)=>setAbout(e.target.value)} value={about}  className='border w-full rounded pt-2 px-4' rows={5} placeholder='Write About Doctor' required></textarea>
                </div>
